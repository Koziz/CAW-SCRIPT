-- [[ KZOYZ HUB - PABRIK MODULE (INJECTED) ]] --
local TargetPage = ...
...
-- BOX SETTING WAKTU TUMBUH & THRESHOLD
...
end)            if gui:IsA("Frame") and string.find(string.lower(gui.Name), "prompt") then gui.Visible = false end
        end
    end)
    task.wait(0.1)
    pcall(function()
